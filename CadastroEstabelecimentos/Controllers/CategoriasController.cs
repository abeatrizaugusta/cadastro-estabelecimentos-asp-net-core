...
namespace CadastroEstabelecimentos.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        private readonly CadastroEstabelecimentosContext _context; //Dependência do DBContext do EntityFramework

        public CategoriasController(CadastroEstabelecimentosContext context)
        {
            _context = context;
        }
